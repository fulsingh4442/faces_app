...
// import 'package:TIBU/logic/bloc/add_addon_to_cart_bloc.dart';
// import 'package:TIBU/logic/bloc/add_on_bloc.dart';
// import 'package:TIBU/logic/bloc/category_bloc.dart';
...
// import 'package:TIBU/ui/widgets/dialog_addons_dart.dart';
//
...
//           InkWell(
//             onTap: (() {
//               ackAlert(context, ClubApp.option);
//               if (Select_items == true) {
...
//                       child: InkWell(
//                         onTap: () {
//                           print("Tappedddfsdv ${_addOnsBloc.tableCart.isNotEmpty ||
...
//                             child: Center(
//                               child: Text(
//                                 model.isAddedToCart ? 'Remove' : 'Add',style: TextStyle(color: Colors.white,),
//
//                                 // style:
//                                 // Theme.of(context)
//                                 //     .textTheme
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    //     onTap: () {
                    //       if(AddedToCart = true ){
                    //         ackAlert(context, ClubApp.package1);
                    //
                    //       }
                    //
                    //       if(model.quantity == 0){
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        //
                        //
                        //       onTap: AddedToCart == false ? () {
                        //         print(_addOnsBloc.tableCart[0].id);
                        //         print("Tappedddfsdv ${_addOnsBloc.tableCart.isNotEmpty ||
                        //             _addOnsBloc.eventCart.isNotEmpty}");
                        //         //  if (model.quantity > 0) {
                        //
                        ...
                        //
                        //                 border: Border.all(
                        //                     color: model.isAddedToCart ? Colors.black : Colors.grey
                        //                 ),
                        //
                        //                 borderRadius:
                        //                 BorderRadius.all(Radius.circular(10))),
                        ...
                        //                   children: [
                        //                     Text(
                        //                       model.isAddedToCart ? 'Added' : 'Add',style: TextStyle(color: model.isAddedToCart ? Colors.white: Colors.grey,),
                        //
                        //                       // style:
                        //                       // Theme.of(context)
                        //                       //     .textTheme
                        ...
                        //   ),
                        //
                        // }else if(_addOnsBloc.tableCart.length == 2)...{
                        //   Container(
                        //     padding: EdgeInsets.all(5),
                        //     child: InkWell(
                        //
                                ...
                                child: Padding(
                                  ...
                                  child: Center(
                                    child: Column(
                                      children: [
                                        IconButton(
                                          icon: model.isAddedToCart ? Icon(Icons.delete_forever,color:Colors.red,) : Icon(Icons.delete_forever,color:Colors.black),
                                          color: Colors.white,
                                          onPressed: () {
                                            if(AddedToCart = true ){
                                              ackAlert(context, ClubApp.package1);
                                          ...
                                          // model.isAddedToCart ? 'Remove' : '',style: TextStyle(color: Colors.white,),
